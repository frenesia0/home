    ...
    <section className="page character-page">
      ...
      <div className="char-hero" style={{ '--char-color': eff.color || '#8083D6' } as React.CSSProperties}>
        <div className="char-copy" style={{ fontFamily: familyOf(eff.bodyFontId) }}>
          ...
          {displayQuote && (
            <blockquote className="quote-ribbons">
...
.mobile-full-toggle{display:grid;place-items:center;position:absolute;z-index:7;right:14px;bottom:14px;width:48px;height:48px;padding:0;border:1px solid rgba(255,255,255,.72);border-radius:50%;background:rgba(18,20,26,.78);color:#fff;font-size:22px;font-weight:400;line-height:1;backdrop-filter:blur(8px)}
...
.char-copy blockquote{margin-top:20px}.quote-ribbons{gap:6px}.quote-ribbons span{padding:7px 10px;font-size:12.5px;line-height:1.6}
